...
module "modules_sdwan-hub-and-spoke" {
  source  = "Juniper/modules/mist//modules/sdwan-hub-and-spoke"
  version = "0.0.1"
  org_id  = "1e149858-b30a-4998-a2b6-953ebc0b8a88" # In this example TF_VAR_org_id environment variable is used instead
